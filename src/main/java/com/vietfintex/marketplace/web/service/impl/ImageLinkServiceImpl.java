...
@Service
public class ImageLinkServiceImpl extends AbstractService<ImagesLink, ImagesLinkDTO> implements ImageLinkService {
    private static final Logger logger = Logger.getLogger(ImageService.class);
    private static final BaseMapper<ImagesLink, ImagesLinkDTO> mapper = new BaseMapper<>(ImagesLink.class, ImagesLinkDTO.class);
    @Autowired
    ...
    @Override
    protected BaseMapper<ImagesLink, ImagesLinkDTO> getMapper() {
        return mapper;
    }
